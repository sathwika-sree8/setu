...
// Query: *[_type=="startup" && defined(slug.current) && ($search == "" || title match $search || category match $search || author->name match $search)]|order(_createdAt desc){    _id,    title,    slug,    _createdAt,    author->{_id,id,name,image,bio    },    views,    description,    category,    image    }
...
export type AUTHOR_BY_EMAIL_QUERY_RESULT = {
  _id: string;
  id: number | null;
  name: string | null;
  username: string | null;
...
// Source: sanity\lib\queries.ts
// Variable: STARTUPS_BY_CLERK_ID_QUERY
// Query: *[_type=="startup" && author->clerkId==$clerkId]|order(_createdAt desc){    _id,    title,    slug,    _createdAt,    author->{_id,id,name,image,bio    },    views,    description,    category,    image    }
export type STARTUPS_BY_CLERK_ID_QUERY_RESULT = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  _createdAt: string;
...
// Source: sanity\lib\queries.ts
// Variable: AUTHOR_BY_CLERK_ID_QUERY
// Query: *[_type == "author" && clerkId == $clerkId][0]{    _id,    clerkId,    name,    username,    email,    image,    bio  }
export type AUTHOR_BY_CLERK_ID_QUERY_RESULT = {
  _id: string;
  clerkId: string | null;
  name: string | null;
  username: string | null;
...
// Query: *[_type=="author" && username == $username][0]{    _id,    clerkId,    name,    username,    email,    image,    bio  }
export type AUTHOR_BY_USERNAME_QUERY_RESULT = {
  _id: string;
  clerkId: string | null;
  name: string | null;
  username: string | null;
...
declare module "@sanity/client" {
  interface SanityQueries {
    '*[_type=="startup" && defined(slug.current) && ($search == "" || title match $search || category match $search || author->name match $search)]|order(_createdAt desc){\n    _id,\n    title,\n    slug,\n    _createdAt,\n    author->{_id,id,name,image,bio\n    },\n    views,\n    description,\n    category,\n    image\n    }': STARTUPS_QUERY_RESULT;
    ...
    '\n    *[_type=="author" && email == $email][0]{\n        _id,\n        id,\n        name,\n        username,\n        email,\n        image,\n        bio\n    }\n': AUTHOR_BY_EMAIL_QUERY_RESULT;
    '\n    *[_type=="author" && _id == $id][0]{\n        _id,\n        id,\n        name,\n        username,\n        email,\n        image,\n        bio\n    }\n': AUTHOR_BY_ID_QUERY_RESULT;
    '*[_type=="startup" && author._ref==$id]|order(_createdAt desc){\n    _id,\n    title,\n    slug,\n    _createdAt,\n    author->{_id,name,image,bio\n    },\n    views,\n    description,\n    category,\n    image\n    }': STARTUPS_BY_AUTHOR_QUERY_RESULT;
    '*[_type=="startup" && author->clerkId==$clerkId]|order(_createdAt desc){\n    _id,\n    title,\n    slug,\n    _createdAt,\n    author->{_id,id,name,image,bio\n    },\n    views,\n    description,\n    category,\n    image\n    }': STARTUPS_BY_CLERK_ID_QUERY_RESULT;
    '*[_type == "playlist" && slug.current == $slug][0]{\n  _id,\n  title,\n  slug,\n  select[]->{\n    _id,\n    _createdAt,\n    title,\n    slug,\n    author->{\n      _id,\n      name,\n      slug,\n      image,\n      bio\n    },\n    views,\n    description,\n    category,\n    image,\n    pitch\n  }\n}': PLAYLIST_BY_SLUG_QUERY_RESULT;
    '\n  *[_type == "author" && clerkId == $clerkId][0]{\n    _id,\n    clerkId,\n    name,\n    username,\n    email,\n    image,\n    bio\n  }\n': AUTHOR_BY_CLERK_ID_QUERY_RESULT;
    '\n  *[_type=="author" && username == $username][0]{\n    _id,\n    clerkId,\n    name,\n    username,\n    email,\n    image,\n    bio\n  }\n': AUTHOR_BY_USERNAME_QUERY_RESULT;
  }
}
